...
msg_t m_empty = "Nothing to insert.";
...
msg_t m_copied = "%ld bytes copied.";
msg_t m_cut = "%ld bytes cut.";
...
msg_t str_output = "*output*";
msg_t str_shell_cmd = "Shell Command: ";
msg_t str_buffers = "*buffers*";
